<?php
  ...
  else if($_SESSION["porte_pleine"]!=true)
  ...
  else if($_SESSION["porte_vitre"]!=true)
  ...
  else if($_SESSION["porte_coulissante"]!=true)
  ...
  else if($_SESSION["porte_bi_cadreAluminium"]!=true)
  ...
  else if($_SESSION["porte_bi_bois"]!=true)
