...
<script type="text/javascript">
    ...
    function downloadPPT()
    {
        ...
        if(e_cj){
            ...
            var vitrage_e_bb_v = <?php echo json_encode($vitrage_e_bb_v); ?>;
            if(vitrage_e_bb_v=="simple_vitrage")
                parement_e_bb_v = "Simple Vitrage";
            if(vitrage_e_bb_v=="double_vitrage")
