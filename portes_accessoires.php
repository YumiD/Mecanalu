<html>
    ...
    <body>
        ...
        <div id="content">
            ...
            <div id="horizontal">
			<span class="legend3"> Béquillage </span>
			<span class="legend3"> Paumelle </span>
			<span class="legend3"> Serrure </span>
                
            <form action="portes_accessoires_formulaire.php" method="post">
